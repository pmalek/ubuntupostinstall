...
# install necessary
sudo apt install neovim software-properties-common git zsh indicator-multiload vlc ubuntu-restricted-extras tmux compizconfig-settings-manager compiz-plugins-extra libappindicator1 python-pip python3-pip htop deluge colormake xsel synaptic openssh-client urlview shutter curl cmake wine winetricks $toinstall -V -y
